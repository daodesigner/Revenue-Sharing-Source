...
async function encodeOrganizerServiceArgs() {
    ...
    const organizerEncodedArgs = ethers.utils.defaultAbiCoder.encode(organizerTypes, organizerValues);
    console.log("EventOrganizerService ABI Encoded Constructor Arguments:", organizerEncodedArgs);
  }
