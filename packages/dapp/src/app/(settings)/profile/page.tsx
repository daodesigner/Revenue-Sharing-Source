...
export default function ProfileSettings() {
    ...
    console.log(`your user id: ${userId} your email: ${userEmail}`)
            ...
            <div className="relative min-h-screen pb-20 flex flex-col items-center">
                ...
                <div className="space-y-8 w-full max-w-3xl px-6">
                    ...
                    <div className="space-y-4">
                        <section className="space-y-6 bg-white p-6 rounded-md shadow-md">
                            <div className="space-y-1">
                                <h3 className="font-inter text-xl font-medium">Your Profile</h3>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="p-2 bg-gray-50 rounded-md text-gray-600">
                                    {/* TO-DO: pull email from session */}
                                    gavin.belson@hooli.com
                                    {/* {session.data?.token.email || 'No email available'} */}
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="p-2 bg-gray-50 rounded-md text-gray-600">
                                    {/* TO-DO: pull username from session */}
                                    Gavin Belson
                                    {/* {session.data?.token.username || 'No username available'} */}
                                </div>
                            </div>
                    ...
                    <div className="space-y-4 bg-white p-6 rounded-md shadow-md">
                        <div className="space-y-1">
                            <h3 className="text-xl font-medium text-red-600">Danger Zone</h3>
