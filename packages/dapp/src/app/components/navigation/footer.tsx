...
function Footer() {  // Capitalized for React component naming convention
   return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 mb-8">
            ...
            <div className="lg:col-span-5">
              <h3 className="text-xl font-semibold text-stone-800 mb-3">Newsletter</h3>
              <p className="text-stone-600 mb-4">Join our newsletter and get the latest updates</p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li>
                      <Link href="/partners" className="text-stone-600 hover:text-stone-900 transition-colors">
                        Partners
                      </Link>
                    </li>
                  </ul>
                ...
                {/* Other Links */}
                <div>
                  <h3 className="text-lg font-semibold text-stone-800 mb-4">Other Links</h3>
                  <ul className="space-y-2">
                    <li>
                      <Link href="/donate" className="text-stone-600 hover:text-stone-900 transition-colors">
                        Donate
                      </Link>
                    </li>
                    <li>
                      <Link href="/distribution" className="text-stone-600 hover:text-stone-900 transition-colors">
                        Insights
                      </Link>
                    </li>
                    <li>
                ...
                {/* Social Links */}
                <div>
                  <h3 className="text-lg font-semibold text-stone-800 mb-4">Social Links</h3>
                  <ul className="space-y-2">
                    <li>
                      <a
