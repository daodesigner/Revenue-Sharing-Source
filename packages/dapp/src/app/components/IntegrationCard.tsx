...
const IntegrationCard = ({ imageUrl, subTitle, title, body, buttonText, comingSoon = false }: IntegrationCardProps) => {
  return (
    <div className="relative flex flex-col group transform transition-all duration-500">
      {/* Image and Labels Container */}
      <div className="relative">
        {/* Top Label */}
        <div className="absolute -top-3 -right-3 bg-orange-600 px-6 py-2 z-[3]
                       shadow-lg transform transition-all duration-300
                       group-hover:shadow-xl group-hover:-translate-y-1">
          <p className="text-xs text-white font-bold tracking-widest uppercase">{subTitle}</p>
        </div>
        ...
        <div className="relative h-[400px] w-full 
          ...
          {/* Title Box */}
          <div className="absolute -bottom-4 -left-1 bg-white p-6 max-w-[85%] 
