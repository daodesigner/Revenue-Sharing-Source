   ...
   return (
      <div className="container mx-auto px-4 py-12">
         <ul className="w-full grid grid-cols-1 gap-8 md:grid-cols-2 lg:gap-12">
            ...
            `}>
               {/* Sharp corner decorations that extend outward */}
               ...
               <div className="relative flex flex-col gap-6 z-10">
                ...
                <h3 className="text-2xl font-bold text-neutral-800">Sample Blog Title</h3>
                   <p className="text-neutral-600  leading-relaxed">
                     This is a sample excerpt for the blog post. It gives a brief overview of the content...
                  </p>
                </div>
                  <Link 
                     href="/blog/sample-id"
                     ><Button  className='flex gap-2 border border-orange-900 bg-orange-900 text-white hover:bg-ornage-900/95 focus:ring-ornage-900' >Read More <ArrowRightIcon className='w-4 h-4 '/></Button>
                  </Link>
               </div>
            </li>
