...
import { InfoIcon, Users, Ticket, TrendingUp, HelpCircle, ExternalLink } from 'lucide-react';
  ...
  const tableData = [
    {
      ...
      tooltip: 'Digital launch of the exhibit on SummitShare platform, including tokenized artifacts and interactive gallery access',
      status: 'green',
    ...
    },
    {
      ...
      tooltip: 'Live exhibition event in Lusaka, Zambia featuring physical artifacts and community engagement',
      status: 'yellow',
    ...
    },
    {
      ...
      tooltip: 'Transfer of collected funds to a secure escrow contract for community benefit (80%) and administrative costs (20%)',
      status: 'orange',
    ...
    },
    {
      ...
      tooltip: 'Community members participate in selecting development projects aligned with SDG goals',
      status: 'orange',
    ...
    <div className="flex flex-col space-y-8 mx-6 mt-6 mb-12 lg:mx-[15%] pb-16 pt-16">
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-2">
          <h1 className="text-3xl font-bold text-stone-800">1. Gwembe Valley</h1>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {stats.map((stat, index) => (
          <Card key={index} className="relative overflow-hidden hover:bg-stone-50 transition-colors">
            <CardContent className="pt-6">
              <div className="absolute top-3 right-3 text-stone-400">{stat.icon}</div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-xl text-stone-800">Project Milestones</CardTitle>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle className="text-xl text-stone-800">Fund Distribution Scheme</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-xl text-stone-800">Next Steps</CardTitle>
          </CardHeader>
          <CardContent>
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-stone-100 flex items-center justify-center">
                  <span className="text-sm font-medium text-stone-800">1</span>
                </div>
                <span className="text-stone-600">Community voting on development objectives</span>
              </li>
              <li className="flex items-start space-x-3">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-stone-100 flex items-center justify-center">
                  <span className="text-sm font-medium text-stone-800">2</span>
                </div>
                <span className="text-stone-600">Project implementation planning</span>
              </li>
              <li className="flex items-start space-x-3">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-stone-100 flex items-center justify-center">
                  <span className="text-sm font-medium text-stone-800">3</span>
                </div>
                <span className="text-stone-600">Fund disbursement and project execution</span>
              </li>
            </ul>
          </CardContent>
        </Card>
