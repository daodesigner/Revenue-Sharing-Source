      ...
      <div className='flex gap-2'>
        ...
        <Link href={'/cya'}>
         ...
         <section className="w-full space-y-6">
            ...
            <p>Explore the lives of the leading ladies through their cherished artifacts, digitally restored and viewable<br/> in stunning detail from all angles.</p>
            </div>
                     ...
                     {loadingItem === item.name ? (
                        ...
                        <>
                           ...
                           <div className="z-[5] space-y-2">
                              ...
                              <p className="text-white/80 text-sm ">Calabash</p>
                              </div>
